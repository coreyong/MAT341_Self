...
% The golden search converges faster to the minimum for less accurate 
% tolerances. The golden search algorithm always converges quicker. The
% successive parabolic interpolation changes convergence speed because it
% is affected by the tolerance. 